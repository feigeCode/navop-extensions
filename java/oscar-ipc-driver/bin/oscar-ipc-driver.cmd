...
set "DIR=%~dp0"
set "JAR=%DIR%lib\oscar-ipc-driver.jar"
set "JDK_HOME=%OSCAR_JDK_HOME%"
...
if not exist "%JAR%" (
  ...
  echo Run 'bash scripts/build-java-driver.sh oscar ^<target^>' before launching the driver. 1>&2
  exit /b 1
)
