...
export type ShellHostModule = 'context' | 'resource' | 'job' | 'event' | 'blob' | 'log' | 'runtime';
...
export type ResourceConnectionFieldType = 'Text' | 'Number' | 'Password' | 'TextArea' | 'Select' | 'Checkbox';
