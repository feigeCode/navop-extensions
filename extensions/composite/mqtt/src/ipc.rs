//! 反向 Host API 通道:secret 经宿主 `ResolveSecret` 解析 `secret://self/...` 引用。
//!
//! 仿照 elasticsearch provider 的 ipc.rs;宿主在打开资源前已按扩展清单的
//! `secrets:read:self.*` 权限完成授权检查。
